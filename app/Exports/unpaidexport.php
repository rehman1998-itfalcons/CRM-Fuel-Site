...
class unpaidexport implements FromCollection, WithHeadings
{
    /**
    ...
    public function collection()
    {
        ...
        if ( $this->start_date == null || $this->end_date == null ) {
            if ($this->search != null) {
                ...
                ->where('records.status', 1)->where('records.deleted_status', 0)->where('records.paid_status',0)
                ->where(function($q){
                ...
                ->where('records.status', 1)->where('records.deleted_status', 0)->where('records.paid_status',0)->get();
            }
        }
