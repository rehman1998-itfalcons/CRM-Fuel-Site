    ...
    <nav class="sidebar">
        ...
        <ul id="sidebar_menu">
            ...
            <li>
                ...
                <ul>
                    <li><a class="active" href="{{ url('supervisor/dashboard') }}">Supervisor </a></li>
                    <li><a class="active" href="{{ url('accountant/dashboard') }}">Accountant </a></li>
                    {{-- <li> <a class="active" href="{{ url('/trash') }}" class="btn btn-sm btn-rounded btn-danger" id="trash_btn">
                            ...
                            </svg> <span class="badge badge-dark trash_span">127</span>
                        </a></li> --}}
