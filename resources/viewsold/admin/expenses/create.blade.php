                                    ...
                                    <div class="col-md-6 col-lg-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="sub_account_id" required>
                                                ...
                                                <option value="{{ $subaccount->id }}">{{ $subaccount->title }}
                                                </option>
                                                @endforeach
                                                @endif
                                            </select>
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description"
                                        value="{{ old('description') }}" row="10" style="height: 137px;"
                                        required></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ref_no"
                                        value="{{ old('ref_no') }}" placeholder="e.g. transaction ID" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="form-group" id="loading-btn">
                                    <button type="submit" class="btn btn-md btn-primary btn-md mr-3">
                                        Add Expense
                                    </button>
                                </div>
                            </div>
