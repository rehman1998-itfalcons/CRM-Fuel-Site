        ...
        <div class="widget-header">
          <div class="row">
            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
              <h4>
                Bank Transactions
                <button type="button" style="float: right;" class="btn btn-md btn-primary" data-toggle="modal" data-target="#addTransactions">
                          ...
                          ?>
                    		...
                    		<td>
                              @if($transaction->status == 0)
                          		<a style="cursor: pointer;" data-toggle="modal" data-target="#allocate" onclick="allocateFunction('{{ $transaction->id }}','{{$amount}}')">Allocate To Me</a>
                              @else
