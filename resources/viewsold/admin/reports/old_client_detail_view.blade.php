...
@section('title','Client Details Report')
@section('css')
            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <h4>Client Details Report</h4>
                        <hr>
                        <form action="{{ URL::to('/client-detail-report-details') }}" method="GET" id="myform">
                            <div class="row">
                                <div class="col-md-3">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <div class="form-group" id="loading-btn">
                                        <button id="submit-btn" class="btn btn-md btn-primary"
    ...
    $('#submit-btn').click(function (e) {
    	    ...
    	    var sub_company_id = $('#sub_company_id').val();
              ...
              //	$.LoadingOverlay("show");
                ...
                //	$.ajax({
                //  type: 'GET',
                //  url: '{{ URL::to('/company-detail-report-details') }}',
                //  data:data,
