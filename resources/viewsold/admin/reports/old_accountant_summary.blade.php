...
@section('title','Accountant Summary Report')
@section('css')
        		...
        		<div class="widget-header">
          			<div class="row">
            			<div class="col-xl-12 col-md-12 col-sm-12 col-12">
                          	<h4>Accountant Summary Report</h4>
              				<hr>
                          	<form action="{{ URL::to('/accounting-summary/report') }}" method="GET" id="myform">
                              <div class="row">
                                  <div class="col-md-3">
    	...
    	$('#submit-btn').click(function (e) {
    	    ...
    	    var sub_company_id = $('#sub_company_id').val();
          	...
          	if (range_type != '' && category_id != '' && company_id != '' && sub_company_id != '') {
               ...
               //	$.ajax({
               //   type: 'GET',
                //  url: '{{ URL::to('/accounting-summary/report') }}',
                //  data:data,
