...
<table width="100%" style="font-family: gothic;" cellpadding="05" id="firsttable">
    <tr>
        <td width="49%" style="  border: 0.1mm solid #eee;background-color:#eee ">
            <h3 class="to"> Delivery Detail Report </h3>
...
<br>
  ...
  @endphp
    <table cellspacing="0" width="100%" style="border: 0.1mm solid #888888" cellpadding="05" id="secondtable">
    <tr style="background-color:#515e6d;color:white;line-height: 10px;">
         <td width="3%" style="border: 0.1mm solid #888888;color:white;">
            <h4 class="to"> S.No </h4>
         </td>
        <td width="3%" style="border: 0.1mm solid #888888;color:white;">
				<h4 class="to"> Invoice No </h4>
		</td>
         <td width="7%" style="border: 0.1mm solid #888888;color:white;">
            <h4 class="to"> Main Company </h4>
         </td>
         <td width="8%" style="border: 0.1mm solid #888888;color:white;">
            <h4 class="to"> Sub Company </h4>
         </td>
      
      <td width="5%" style="border: 0.1mm solid #888888;color:white;">
				<h4 class="to"> Operator Name </h4>
	  </td>
       <td width="5%" style="border: 0.1mm solid #888888;color:white;">
				<h4 class="to"> Date Time </h4>
	  </td>
       <td width="4%" style="border: 0.1mm solid #888888;color:white;">
				<h4 class="to"> Load No </h4>
	  </td>
       <td width="5%" style="border: 0.1mm solid #888888;color:white;">
				<h4 class="to"> Order No </h4>
	  </td>
       <td width="5%" style="border: 0.1mm solid #888888;color:white;">
				<h4 class="to"> Fuel Company </h4>
	  </td>
      <td width="5%" style="border: 0.1mm solid #888888;color:white;">
				<h4 class="to"> Split/Full Load </h4>
	  </td>
      <td width="5%" style="border: 0.1mm solid #888888;color:white;">
				<h4 class="to"> E-Mail Status </h4>
	  </td>
      @php
   ...
   @foreach($rec->where('status',1)->where('deleted_status',0) as $record)
     <tr>
          <td height="30px" width="3%" style="border: 0.1mm solid #888888;">
              <p class="to">{{++$i}}</p>
          </td>
          <td height="30px" width="3%" style="border: 0.1mm solid #888888;">
              <p class="to">{{$record->invoice_number}}</p>
          </td>
          <td height="30px" width="7%" style="border: 0.1mm solid #888888;">
              <p class="to">{{ ($record->company_id) ? $record->company->name : $record->subCompany->company->name  }}</p>
          </td>
          <td height="35px" width="8%" style="border: 0.1mm solid #888888;">
              <p class="to"> {{($record->sub_company_id) ? $record->subCompany->name : '-'}} </p>
          </td>
          <td height="30px" width="5%" style="border: 0.1mm solid #888888;">
              <p class="to">{{$record->user->name}}</p>
          </td>
         <td height="30px" width="5%" style="border: 0.1mm solid #888888;">
              <p class="to">{{\Carbon\Carbon::parse($record->datetime)->format('d-m-Y')}}</p>
          </td>
         <td height="30px" width="4%" style="border: 0.1mm solid #888888;">
              <p class="to">{{$record->load_number}}</p>
          </td>
         <td height="30px" width="5%" style="border: 0.1mm solid #888888;">
              <p class="to">{{$record->order_number}}</p>
          </td>
         <td height="30px" width="5%" style="border: 0.1mm solid #888888;">
              <p class="to">{{$record->supplierCompany->name}}</p>
          </td>
        <td height="30px" width="5%" style="border: 0.1mm solid #888888;">
              <p class="to">{{$record->splitfullload}}</p>
          </td>
        <td height="30px" width="5%" style="border: 0.1mm solid #888888;">
              <p class="to">{{($record->email_status == 1) ? 'Send' : 'Not Send'}}</p>
          </td>
        @foreach($products as $product)
       	<?php
  ...
  @endif
    <tr style="background-color:#515e6d;">
        <td height="15px" width="3%" style="border: 0.1mm solid #888888;color:white;">
            <p class="to"> <b> Total </b> </p>
        </td>
       <td colspan="1" height="15px" width="3%" style="border: 0.1mm solid #888888;color:white;"></td>
       <td colspan="1" height="15px" width="7%" style="border: 0.1mm solid #888888;color:white;"></td>
       <td colspan="1" height="15px" width="8%" style="border: 0.1mm solid #888888;color:white;"></td>
       <td colspan="1" height="15px" width="5%" style="border: 0.1mm solid #888888;color:white;"></td>
       <td colspan="1" height="15px" width="5%" style="border: 0.1mm solid #888888;color:white;"></td>
       <td colspan="1" height="15px" width="4%" style="border: 0.1mm solid #888888;color:white;"></td>
       <td colspan="1" height="15px" width="5%" style="border: 0.1mm solid #888888;color:white;"></td>
       <td colspan="1" height="15px" width="5%" style="border: 0.1mm solid #888888;color:white;"></td>
       <td colspan="1" height="15px" width="5%" style="border: 0.1mm solid #888888;color:white;"></td>
       <td colspan="1" height="15px" width="5%" style="border: 0.1mm solid #888888;color:white;"></td>
