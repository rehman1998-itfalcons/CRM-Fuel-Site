...
{{-- <script src="{{ asset('admin/js/metisMenu_1048644.js') }}"></script> --}}
                                    ...
                                    <div class="col-12">
                                        <div class="quick_activity_wrap">
                                            ...
                                            <div class="single_quick_activity d-flex">
                                                ...
                                                <div class="count_content">
                                                    <h3><span
                                                            class="counter">{{ $sales->where('status', 0)->where('deleted_status', 0)->count() }}</span>
                                                    </h3>
                                                    <p>Pending Records</p>
                                                </div>
                                            </div>
                            ...
                            <div class="income_servay">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="count_content">
                                            <h3> <span
                                                    class="counter">{{ $sales->where('status', 1)->where('paid_status', 0)->where('deleted_status', 0)->count() }}</span>
                                            </h3>
                                            <p>UNPAID INVOICES</p>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="count_content">
                                            <h3>$ <span class="counter">{{ number_format($unpaid_balance, 2) }}</span>
                                            </h3>
                                            <p>UNPAID BALANCE</p>
                                        </div>
                                    </div>
                                    ...
                                    $getoverdues = 0;
                                    if ($set_category != '' && $set_category != 0) {
                                        $num_records = Record::where('category_id', $_GET['category'])
                                            ->where('status', 1)
                                            ->where('paid_status', 0)
                                            ->where('deleted_status', 0)
                                            ->get();
                                    } else {
                                        $num_records = Record::where('status', 1)
                                            ->where('paid_status', 0)
                                            ->where('deleted_status', 0)
                                            ->get();
                                    }
                                    ...
                                    <div class="col-md-3">
                                        <div class="count_content">
                                            <h3>$ <span class="counter">{{ number_format($overdue_balance, 2) }}</span>
                                            </h3>
                                            <p>OVERDUE BALANCE</p>
                                        </div>
                                    </div>
