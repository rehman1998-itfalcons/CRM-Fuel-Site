            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <div class="">
                  @if($chart_accounts->count() > 0)
                    <form action="{{ route('store.subaccount') }}" method="POST" enctype="multipart/form-data" onsubmit="return loginLoadingBtn(this)">
                        @csrf
                        <div class="form-row mb-4">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('code') is-invalid @enderror" readonly name="code" required  value="{{ mt_rand(1000,9999) }}">
                                @error('code')
                                <span class="invalid-feedback" role="alert">
	                                        <strong>{{ $message }}</strong>
	                                    </span>
                        ...
                        <div class="form-row mb-4">
                            <div class="form-group col-md-12" id="loading-btn">
                                <button type="submit" class="btn btn-primary btn-lg mr-3" id="submit-btn">Add Sub Account</button>
                            </div>
                        </div>
                    </form>
                  @else
