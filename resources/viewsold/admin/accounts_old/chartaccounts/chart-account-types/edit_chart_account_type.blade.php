...
@section('title','Edit Chart Account Type')
@section('css')
    ...
    <div class="row layout-top-spacing" id="cancel-row">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <hr>
                <div class="">
                    <form action="{{ route('update.chart.account_type',$chartaccounttype->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return loginLoadingBtn(this)">
                        @csrf
                        <div class="form-row mb-4">
                            <div class="form-group col-md-6">
                                <label>Title</label>
                                <span style="color: red;"> *</span>
                                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" placeholder="enter title of COA Type" required  value="{{ $chartaccounttype->title }}">
                                @error('title')
                        ...
                        <div class="form-row mb-4">
                            <div class="form-group col-md-12" id="loading-btn">
                                <button type="submit" class="btn btn-primary btn-lg mr-3" id="submit-btn">Edit Record</button>
                            </div>
                        </div>
                    </form>
                </div>
