            ...
            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
              	...
              	<div class="col-md-3"><a href="{{ url('upload-purchase-invoices') }}"><button  style="float: right;" type="button" class="btn btn-md btn-primary" >Click to upload on Myob</button></a> </div>
                <div class="col-md-3"><a href="{{ url('purchase-invoice-sync') }}"><button  style="float: left;" type="button" class="btn btn-md btn-success" >Sync purchase invoices UID</button></a> </div>
    	...
    	$(".select-change").change(function () {
          ...
          var company = $("#select-company").val();
          	...
          	if (from != '' && to != '') {
                 ...
                 dataTable = $('#html5-extension').DataTable();
                 $('#body_result').html(data);
                 $('#html5-extension').DataTable().ajax.reload();
