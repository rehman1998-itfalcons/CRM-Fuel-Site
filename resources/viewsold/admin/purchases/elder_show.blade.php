...
@section('contents')
    ...
    <div class="row layout-top-spacing container-fluid p-10" id="cancel-row">
                    ...
                    <div class="row button1">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 p-10">
                            <h4>Purchase Details
                                ...
                                <button style="float: right;" class="btn btn-md btn-danger" data-bs-toggle="modal" data-bs-target="#delete">
                                    Delete
                                </button>
                              ...
                              @if (! $purchase->total_amount - $purchase->paid_amount == 0)
                                <button style="float: right;" class="btn btn-md btn-outline-primary btn-rounded" data-bs-toggle="modal" data-bs-target="#addPayment">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10">

                                    </line></svg>&nbsp; Add Payment
                                </button>
                              @endif
                            </h4>
                        </div>
