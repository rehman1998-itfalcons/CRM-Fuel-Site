                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 p-10">
                            <h4>Purchase Details
                              ...
                              {{-- @if (! $purchase->total_amount - $purchase->paid_amount == 0)
                                <button style="float: right;" class="btn btn-md btn-primary btn-rounded" data-bs-toggle="modal" data-bs-target="#addPayment">
