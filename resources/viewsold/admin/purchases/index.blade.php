                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1 btn-group">
                                    {{-- <button type="button" name="csv" id="Excel" class="btn btn-primary">CSV</button> --}}
 ...
 --}}
    ...
    <script type="text/javascript">
        $('#Excel').on('click', function() {
            ...
            window.location.href = "{{ route('purchase.export') }}/?start_date=" + $start_date + "&end_date=" + $end_date + "&search=" + $search;
        })
    </script>
    <script>
