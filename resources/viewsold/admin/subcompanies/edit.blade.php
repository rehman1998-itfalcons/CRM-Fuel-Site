        			...
        			<div class="widget-content widget-content-area">
						<form action="{{ route('subcompanies.update',$subcompany->id) }}" method="POST" id="company-form">
                            ...
                            <div class="col-md-6">
                              ...
                              <select name="category_id" class="form-control" disabled="disabled" id="category_id" onchange="updateCategory('{{$subcompany->id}}')" required>
                               ...
                               <div class="col-md-6">
                                 <label>Main Company</label>
						            <small style="color: red;"> *</small>
						            <select name="company_id" id="company_id" disabled="disabled"  class="form-control">
                                      <option value="">--Select--</option>
                          	...
                          	<div class="form-row mb-4">
						        <div class="col-md-6">
						            ...
						            <small style="color: red;"> *</small>
						            <input type="text" readonly="readonly"  name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Sub Company" required autocomplete="off" value="{{ $subcompany->name }}">
	                                @error('name')
