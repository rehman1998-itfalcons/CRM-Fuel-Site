          ...
          <div class="row">
            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <a href="{{ url('purchase-sync') }}"><button  style="float: right;" type="button" class="btn btn-md btn-success" >Sync Purchase invoices UID</button></a>
                  </div>
              </div>
              <br>
                  ...
                  <tbody id="body_result">
                    @foreach ($purchases as $purchase)
                    	<tr>
                    		...
                    		<td>{{ \Carbon\Carbon::parse($purchase->datetime)->format('d-m-Y') }}</td>
