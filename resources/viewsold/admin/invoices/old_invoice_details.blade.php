                    ...
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div style="float: right;">
                              <button class="btn btn-md btn-outline-primary btn-rounded" data-toggle="modal" data-target="#followsModal">
                                ...
                                <a href="{{ route('records.show',$record->id) }}" class="btn btn-md btn-outline-primary btn-rounded">
                                ...
                                <button class="btn btn-md btn-outline-primary btn-rounded" data-toggle="modal" data-target="#addPayment">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>&nbsp; Add Payment
                                </button>
                                <button class="btn btn-md btn-outline-primary btn-rounded" data-toggle="modal" data-target="#sendMail">
                                ...
                                <button class="btn btn-md btn-outline-primary btn-rounded" onclick="printInvoice('invoice_print')">
                                ...
                                <a href="{{ route('invoice',$record->id) }}" target="_blank" class="btn btn-md btn-outline-primary btn-rounded">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2" style="padding: 0px;">
                            @if($invoicedata->invoice_logo)
                                <img src="{{($invoicedata) ? asset('/uploads/siteinvoice/'.$invoicedata->invoice_logo) : '' }}" class="img-fluid">
                            @else
                                <img src="{{ asset('assets/img/atlas_logo.png') }}" class="img-fluid">
                            @endif
                        </div>
                        <div class="col-md-5">
                            <hr style="border-top: 4px solid #1db239; margin-top: 95px;">
...
Otherwise , any amount paid will not be accepted and will be returned'}}</span>
                    ...
                    <div class="row text-center">
                        <div class="col-sm-12">
                            ...
                            <div style="float: right; display: contents;">
                                <img src="{{ asset('uploads/line-bar.png') }}" width="30%">
                    ...
                    <div class="row" style="background: #111; color: #fff; padding: 20px;">
                        <div class="col-sm-4">
                            <img src="{{ asset('uploads/call.jpg') }}" width="40px" height="" width="40px">{{($invoicedata->invoice_phone_no) ? $invoicedata->invoice_phone_no : '(+61) 437 485 565'}}
                        </div>
                        <div class="col-sm-4">
                            <img src="{{ asset('uploads/mail.jpg') }}" width="40px">{{($invoicedata->invoice_email) ? $invoicedata->invoice_email : 'logistics@smjunited.com'}}
                        </div>
                        <div class="col-sm-4">
                            <img src="{{ asset('uploads/location.jpg') }}" width="40px">{{($invoicedata->invoice_address) ? $invoicedata->invoice_address : '2095 Toodyay rd -Gidgegannup WA 6083'}}
                        </div>
                    </div>
