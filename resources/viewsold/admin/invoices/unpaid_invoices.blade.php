...
<script type="text/javascript">
    $('#Excel').on('click', function() {
        ...
        window.location.href = "{{ route('unpaidexport.export') }}/?start_date=" + $start_date + "&end_date=" + $end_date + "&search=" + $search;
    })
</script>
    <script type="text/javascript">
