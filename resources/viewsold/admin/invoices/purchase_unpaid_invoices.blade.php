                    ...
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="row" id="custom-range" style="display: none;">
                                <div class="col-md-3">
                                    <input type="text" id="from_date" class="form-control flatpickr flatpickr-input"
                                        placeholder="Select From Date">
                                </div>
                                <div class="col-md-3">
                                    <input type="text" id="to_date" class="form-control flatpickr flatpickr-input"
...
<script type="text/javascript">
    $('#Excel').on('click', function() {
        ...
        window.location.href = "{{ route('purchaseunpaidinvoicesex.export') }}/?start_date=" + $start_date + "&end_date=" + $end_date + "&search=" + $search;
    })
</script>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            tableRecords = $('.data-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('purchase.unpaid.invoices') }}',
                    data: function(d) {
                        var from_date = $('#from_date').val();
                        var to_date = $('#to_date').val();
