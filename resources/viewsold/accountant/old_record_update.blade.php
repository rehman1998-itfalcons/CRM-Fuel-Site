...
@section('css')
    ...
    <link rel="stylesheet" href="{{url('resources/views/accountant/assets/rotate/jquery.magnify.css')}}" />
    <style>
        .widget-content-area {
...
@section('scripts')
    ...
    <script src="{{url('resources/views/accountant/assets/rotate/jquery.magnify.js')}}"></script>
    <script>
