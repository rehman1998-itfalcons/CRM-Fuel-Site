            ...
            <div class="QA_section">
                <div class="white_box_tittle list_header">
                    ...
                    <div class="box_right d-flex lms_block">
                        ...
                        <div class="add_button ms-2">
                            <a href="{{ route('records.index') }}" class="btn btn-md btn-primary"
                            style="float: right;">
                ...
                <div class="widget-content widget-content-area">
                    <form action="{{ route('records.update',$record->id) }}" method="POST"
                        onsubmit="return loginLoadingBtn(this)" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="driver_id" class="form-control" required>
                                        ...
                                        <option value="{{ $driver->id }}" {{ ($record->user_id == $driver->id) ?
                                            'selected' : '' }}>
                                            {{$driver->name}}
                                        </option>
                                        @endforeach
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="datetime" id="datetimepicker1" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 ">
                               <div class="form-group">
                                ...
                                <a data-magnify="gallery" data-caption="Image"
                                    href="{{ asset('/uploads/records/'.$file) }}" class="btn btn-outline-dark mb-2 mr-2"
                                ...
                                <a href="{{ asset('/uploads/records/'.$file) }}" download="{{$file}}"
                                ...
                                <button type="button" class="btn btn-outline-danger mb-2" data-bs-toggle="modal"
                                    data-bs-target="#delete" onclick="deleteAttachment('{{ $file }}')">Delete</button>
                                @php
                                $i++;
                                @endphp
                                @endforeach
                                ...
                                <br>
                                <br>
                                <input type="file" name="billoflading[]" id="file_input"
                                    class="form-control file_input @error('billoflading.*') is-invalid @enderror">
                                @error('billoflading.*')
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <button type="button" class="btn btn-outline-danger mb-2" data-bs-toggle="modal"
                                    data-bs-target="#deleteDocket"
                                    onclick="deleteAttachment1('{{ $file }}')">Delete</button>
                                @php
                                $i++;
                                @endphp
                                @endforeach
                                ...
                                <br>
                                <br>
                                <input type="file" name="deleverydocket[]" id="deliverydocket"
                                    class="form-control file_input @error('deleverydocket.*') is-invalid @enderror">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="load_number" value="{{ $record->load_number }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="order_number" value="{{ $record->order_number }}"
                                        class="form-control" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="fuel_company" value="{{ old('fuel_company') }}">
                                        ...
                                        <option value="{{$company->id}}" {{ ($record->supplier_company_id ==
                                            $company->id) ? 'selected' : '' }}>
                                            {{$company->name}}
                                        </option>
                                        @endforeach
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="category_id" id="category_id" class="form-control">
                                        ...
                                        <option value="{{ $category->id }}" {{($record->category_id == $category->id) ?
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="company_id" id="company_id" class="form-control">
                                        ...
                                        <option value="{{ $company->id }}" {{($record->subCompany->company->id ==
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <span style="color: red;"> (Previous: {{ ($record->sub_company_id) ?
                                        $record->subCompany->name : 'No previous sub company' }})</span>
                                    <select name="sub_company_id" id="sub_company_id" class="form-control">
                                        <option value="">--Select--</option>
                                        @php
                                        $subcompany =
                                        \App\SubCompany::where('status',1)->where('id',$record->sub_company_id)->first();
                                        @endphp
                            ...
                            <table class="table table-bordered mb-4">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if($category->rate_whole_sale != '')
                                        <td>
                                            <input type="number" name="whole_sale_price_{{$product->id}}"
                                                value="{{($product->whole_sale ? $product->whole_sale: '')}}"
                                                class="form-control" @if($category->whole_sale_display == 2) disabled
                                            @endif>
                                        </td>
                                        @endif
                                        @if($category->rate_discount != '')
                                        ...
                                        <td>
                                            <input type="number" class="form-control"
                                                value="{{$product->delivery_rate}}" disabled>
                                        </td>
                                        @endif
                                        @if($category->rate_brand_charges != '')
                                        <td>
                                            <input type="number" class="form-control"
                                                value="{{$product->brand_charges}}" disabled>
                                        </td>
                                        @endif
                                        @if($category->rate_cost_of_credit != '')
                                        <td>
                                            <input type="number" class="form-control"
                                                value="{{$product->cost_of_credit}}" disabled>
                                        </td>
                                        @endif
                                    </tr>
                                    @endforeach
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="splitfullload" class="form-control" required>
                                        <option value="">--Select--</option>
                                        <option value="Split Load" {{ ($record->splitfullload == 'Split Load') ?
                                            'selected' : '' }}> Split Load</option>
                                        <option value="Full Load" {{ ($record->splitfullload == 'Full Load') ?
                                            'selected' : '' }}> Full Load </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Include Split Load Charges?</label> <span style="color: red;"> (Previous:
                                        ...
                                        @endif )</span>
                                    <br>
                                    <input type="radio" name="split_load_tax" value="1" {{ ($record->split_load_status==
                                    1)? "checked" : "" }}> Yes <br>
                                    <input type="radio" name="split_load_tax" value="0" {{ ($record->split_load_status==
                                    0)? "checked" : "" }}> No
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="split_desc" style="display: none;">
                            ...
                            <textarea class="form-control" name="split_load_des"
                                rows="3">{{$record->split_load_des}}</textarea>
                        </div>
                        ...
                        <div class="form-group form-check">
                            ...
                            <label id="confirm1-label">
                                <input type="checkbox" class="form-check-input" value="confirm1" id="confirm1"
                                    name="confirm1" required>
                        ...
                        <div class="form-group form-check">
                            ...
                            <label id="confirm2-label">
                                <input type="checkbox" class="form-check-input" value="confirm2" id="confirm2"
                                    name="confirm2" required>
