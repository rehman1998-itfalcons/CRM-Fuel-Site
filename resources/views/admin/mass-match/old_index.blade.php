...
<style>
    ...
    .btn-info {
        color: #fff !important;
        background-color: #0788ef !important;
        border-color: #0788ef !important;
    }
</style>
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        <button id="submit-btn" class="btn btn-md btn-rounded btn-primary"
                            style="height: 44.57px; width: 10%; background-color: #95a3c7 !important; border-color: #95a3c7;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="feather feather-search">
                                <circle cx="11" cy="11" r="8"></circle>
...
{{--  complete  --}}
            ...
            <div class="row text-center"
                style="background-color: #1b55e2; padding: 6px; border-radius: 5px; margin: 0px;">
                <div class="col-md-6">
                ...
                <div class="row justify-content-center mt-3 mb-3 items" id="purchase_order_{{ $purchase->id }}">
                        ...
                        <div class="purchase_order">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-6">
                                    ...
                                    $j = 1;
                                    @endphp
                                    <a id="purchase-details_{{ $purchase->id }}" data-bs-toggle="modal"
                                        data-bs-target="#viewDetails1"
                    ...
                    <div class="col-md-2">
                        <button type="button" data-bs-toggle="modal" data-bs-target="#confirmMatch"
                            ...
                            style=" background-color: #5d78ff; border-color: #5d78ff; margin-left: 15%; position: absolute; top: 40%;">
                    ...
                    <div class="col-md-5">
                                    ...
                                    <div class="sale-order">
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                $j = 1;
                                                @endphp
                                                <a data-bs-toggle="modal" data-bs-target="#viewDetails"
                                                    ...
                                                    @endforeach class="btn btn-sm btn-info"
                                                    style="padding: 3px;">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        @endforeach
                        @if($flag == 0)
                        <a href="{{ route('manual.insertion',$purchase->id) }}" class="btn btn-md btn-info text-center"
