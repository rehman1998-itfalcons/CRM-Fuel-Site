                        ...
                        <form action="{{ route('invoice.setting..update') }}" method="POST" enctype="multipart/form-data" onsubmit="return loginLoadingBtn(this)">
                                @csrf
                                 <strong>Selected Logo:</strong>
                                   <img src="{{($invoice) ? asset('/uploads/siteinvoice/'.$invoice->invoice_logo) : '' }}" alt="" class="image"><br>
                          ...
                          <div class="form-row mb-4">
                            ...
                            <strong>Selected Images:</strong>
                                                ...
                                                @endphp
                                 @if($invoice->pay_online_imges) 
                                 @foreach ($files as $file)
                                 <img src="{{($invoice) ? asset('/uploads/siteinvoice/'.$file) : '' }}" alt="" class="images">
                          ...
                          <div class="form-row mb-4">
                                    <div class="form-group col-md-6">
                                       ...
                                       @if($invoice->telephone_header_img1 != 'NULL')
                                       <img src="{{($invoice) ? asset('/uploads/siteinvoice/'.$invoice->telephone_header_img1) : '' }}" alt="" class="images">
                                      <button type="button" class="deletebtn" data-toggle="modal" data-target="#deleteImage" onclick="deleteImage('{{ $invoice->telephone_header_img1 }}')"><svg style="margin-bottom: 60px;" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>
                                      @endif
                                      <br>
                                      ...
                                      <div class="form-group col-md-6">
                                        ...
                                        <strong class="ml-4">Selected Image:</strong>
                                        @if($invoice->telephone_header_img2 != 'NULL')
                                         <img src="{{($invoice) ? asset('/uploads/siteinvoice/'.$invoice->telephone_header_img2) : '' }}" alt="" class="images">
