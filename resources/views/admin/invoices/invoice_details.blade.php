                            ...
                            <form action="{{ route('pay.invoice') }}" method="POST" onsubmit="return loginLoadingBtn1(this)">
                                <div class="modal-body">
                                  ...
                                  <label>Select Date Time</label>
						            ...
						            <input type="text" name="payment_datetime" value="{{old('payment_datetime')}}" placeholder="DD-MM-YYYYY" class="form-control flatpickr-input active"  id="datetimepicker1" required>
                                   </div>
