...
<div class="container-fluid p-10">
    ...
    <div class="row layout-top-spacing" id="cancel-row" >
        <div class="col-xl-8 col-lg-8 col-sm-8 col-md-8  layout-spacing">
            @if ($errors->any())
            ...
            <ul class="alert alert-success"
                style="background: #5cdc93; color: #fff; font-weight: 300; line-height: 1.7; font-size: 16px; list-style-type: success;">
                {!! implode('', $success->all('<li>:message</li>')) !!}
            </ul>
        @endif --}}
            <div class="widget-content br-6 p-10">
                <div class="widget-header p-10">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 p-5 col-12 p-10">
                            <h4>
                                User Details
                ...
                @if ($user->role->name == 'Driver')
                    ...
                    @foreach ($attachments as $key => $value)
                        <a href="{{ URL:: asset('public/uploads/' . $value) }}" target="_blank"
                            class="text-primary">{{ $value }}</a>
                    @endforeach
                @endif
            </div>
        </div>
        <div class="col-xl-4 col-lg-4 col-sm-4  layout-spacing p-10">
            <div class="widget-content br-6 p-10">
                <div class="widget-header p-10">
                    <h4 class="p-3">{{ $user->name }}</h4>
                    <hr>
                    @if ($user->photo)
                        <img src="{{ URL:: asset('public/uploads/profile/' . $user->photo) }}" class="img-fluid p-3">
                    @else
                        <img src="{{ URL:: asset('public/uploads/default.png') }}" class="img-fluid p-3">
                    @endif
                </div>
            </div>
        </div>
