                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>
                                Roles
                                <button style="float: right; display: none;" type="button" class="btn btn-md btn-primary" data-toggle="modal"
                                        data-target="#addRole">Add Role
                                </button>
                            </h4>
                        </div>
                    </div>
                    ...
                    <div id="zero-config_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                        <table id="zero-config" class="table table-hover dataTable" style="width:100%" role="grid"
                            ...
                            <tr role="row">
                                ...
                                <th class="sorting" style="display: none;">Action</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php $i = 1; ?>
                            @foreach ($roles as $role)
                                <tr role="row">
                                    ...
                                    <td style="display: none;">
                                        <button @if($role->slug == 'super-admin') disabled @else data-toggle='modal' data-target='#editRole' onclick="editRole('{{ $role->id }}','{{ $role->name }}')" @endif class="btn btn-sm btn-primary">
