        ...
        <div class="col-sm-12 ">
            <div class="QA_section">
                <div class="white_box_tittle list_header">
                    ...
                    <div class="box_right d-flex lms_block">
                        ...
                        <div class="add_button ms-2">
                            {{-- <a href="{{ url('suppliercompany-sync') }}"> <button style="float: right;" type="button" class="btn btn-md btn-primary topp" >Sync Suppliers UID

                            </button></a> --}}
                            <a href="#" data-bs-toggle="modal" data-bs-target="#addRole"
                                class="btn btn-md btn-primary">Add Company</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="QA_table mb_30">
                    ...
                    {{-- <table id="zero-config" class="table lms_table_active"> --}}
                        <thead>
                            <tr role="row">
                                <th class="sorting">#</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($companies as $company)
                                <tr role="row">
                                    ...
                                    <td>{{ $company->name }}</td>
                                    <td>
                                        <button data-bs-toggle='modal' data-bs-target='#editRole' onclick="editRole('{{ $company->id }}','{{ $company->name }}')" class="btn btn-sm btn-primary btn-custom">
