...
<table width="100%" style="font-family: gothic;" cellpadding="05" id="firsttable">
    <tr>
        <td width="49%" style="  border: 0.1mm solid #eee;background-color:#eee ">
            <h3 class="to"> Account Summary </h3>
...
<br>
  ...
  @endphp
    ...
    <tr style="background-color:#515e6d;color:white;line-height: 1px;">
        ...
        <td width="35%" style="border: 0.1mm solid #888888;color:white;">
   ...
   @foreach($rec->where('status',1)->where('deleted_status',0) as $record)
     <tr>
          ...
          <td height="35px" width="35%" style="border: 0.1mm solid #888888;">
  ...
  @endif
    <tr style="background-color:#515e6d;">
       ...
       <td colspan="1" height="15px" width="30%" style="border: 0.1mm solid #888888;color:white;"></td>
       <td colspan="1" height="15px" width="35%" style="border: 0.1mm solid #888888;color:white;"></td>
       <td colspan="1" height="15px" width="15%" style="border: 0.1mm solid #888888;color:white;">
          ${{number_format($whole_totalamount, 2)}}
        </td>
        <td height="15px" width="15%" style="border: 0.1mm solid #888888;color:white;">
