...
<table cellspacing="0" width="100%" style="border: 0.1mm solid #888888; float:left;" cellpadding="8" id="secondtable">
    <tr style="background-color:#515e6d;color:white;line-height: 1px;">
        <td width="10%" style="border: 0.1mm solid #888888;color:white;">
            <h4 class="to"> Serial No </h4>
        </td>
        <td width="30%" style="border: 0.1mm solid #888888;color:white;">
            <h4 class="to"> Main Company </h4>
        </td>
        <td width="32%" style="border: 0.1mm solid #888888;color:white;">
            <h4 class="to"> Sub Company </h4>
        </td>
        <td width="15%" style="border: 0.1mm solid #888888;color:white;">
            <h4 class="to"> Total Sales </h4>
        </td>
    </tr>
  @if($records)
  @foreach($records as $rec)
   @foreach($rec as $record)
     <tr>
          ...
          <td height="30px" width="30%" style="border: 0.1mm solid #888888;">
              <p class="to">{{ ($record->company_id) ? $record->company->name : $record->subCompany->company->name  }}</p>
          </td>
          <td height="30px" width="32%" style="border: 0.1mm solid #888888;">
              <p class="to"> {{($record) ? $record->subCompany->name : '-'}} </p>
          </td>
         @php
         $per_row_amount = $record->total_amount;
         @endphp
          <td height="30px" width="15%" style="border: 0.1mm solid #888888;">
              <p class="to"> ${{number_format($per_row_amount,2)}} </p>
          </td>
      </tr>
  
  @php
  $whole_amount = $whole_amount + $per_row_amount;
  @endphp
  @endforeach
  @endforeach
  @endif
    <tr style="background-color:#515e6d;">
        ...
        <td colspan="1" height="15px" width="30%" style="border: 0.1mm solid #888888;color:white;">
        </td>
        <td height="15px" width="32%" style="border: 0.1mm solid #888888;color:white;">
        </td>
        <td height="15px" width="15%" style="border: 0.1mm solid #888888;text-align:right;color:white;">
            <p class="to"> <b> ${{number_format($whole_amount,2)}} </b> </p>
        </td>
    </tr>
</table>
<br>
