            ...
            <div class="col-sm-12 ">
                <div class="QA_section">
                    <div class="white_box_tittle list_header">
                        <h2>Overdue Sales Report - {{ $date }}</h2>
                    ...
                    <div class="QA_table mb_30">
                        ...
                        <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr class="yellow-tooltip" @if($record->follows_note) title="{{ $record->follows_note
                                    }}"
                                    @endif>
                                    <td>{{ $sno++ }}</td>
                                    ...
                                    <td>
                                        <a href="{{ route('invoice.details',$record->id) }}"
                                            class="btn btn-sm btn-primary btn-custom" style="color: white">View</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
