            ...
            <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    ...
                    <form action="{{ url('/expenses-update',$expense->id) }}" method="POST"
                        enctype="multipart/form-data" onsubmit="return loginLoadingBtn(this)">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="sub_account_id" required>
                                                ...
                                                <option value="{{ $subaccount->id }}" {{ ($expense->sub_account_id
                                                    == $subaccount->id) ? 'selected' : '' }}>{{ $subaccount->title
                                                    }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="datetime" id="datetime"
                                                value="{{ \Carbon\Carbon::parse($expense->datetime)->format('d-m-Y H:i') }}"
                                                required>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" row="10"
                                        style="height: 137px;" required>{{ $expense->description }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ref_no"
                                        value="{{ $expense->ref_no }}" placeholder="e.g. transaction ID" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <span style="margin-left: 50px;font-weight: 700;">
                                    ...
                                    <button type="button" class="deletebtn" data-bs-toggle="modal"
                                        data-bs-target="#delete" onclick="deleteAttachment('{{ $file }}')"><svg
                                            style="margin-bottom: 60px;" xmlns="http://www.w3.org/2000/svg"
