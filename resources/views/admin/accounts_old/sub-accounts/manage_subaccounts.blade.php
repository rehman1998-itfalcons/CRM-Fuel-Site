...
@endif
      	<div class="widget-content widget-content-area br-6">
           <h4>Sub Accounts
          <a href="{{route('create.subaccount')}}" class="btn btn-primary" style="float:right;"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>Add New Sub Account</a>
          </h4>
              ...
              <tbody>
                ...
                @foreach ($subaccounts as $account)
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('edit.subaccount',$account->id) }}" class="btn btn-sm btn-primary btn-cust">Edit</a>
                      <a class="btn btn-sm btn-danger btn-cust" data-bs-toggle="modal" data-bs-target="#deleteModal" onclick="deleteSubAccount('{{ $account->id }}')" style="display: none;">Delete</a>
                    </td>
                  </tr>
                @endforeach
              </tbody>
